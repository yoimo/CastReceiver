# Joymo Simple CastReceiver App

This application is a modified version of the original cast receiver reference implementation. One of the main differences is that it compiles to a single bundled html using webpack.
